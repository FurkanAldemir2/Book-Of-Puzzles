...
public class MediumMenu extends JPanel implements ActionListener  {	
Image back,wood; 
JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,bc1,bc2,bc3,bc4,bc5,bc6,bc7,bc8,bc9,N;   
JLabel woodPlate;
...
static int ShuffleConstant,RandomConstant,ArtConstant;
...
JLabel label = new JLabel();
 MediumMenu()throws UnsupportedAudioFileException, IOException, LineUnavailableException {
    ...
    b11.setBounds(1500,166,60,60); N.setBounds(1180,160,140,70);
  ...
  /* do {
    ...
    ArtConstant = x.nextInt(100)+1;
    
     System.out.println(ShuffleConstant);
 
     ImageIcon icon0 = new ImageIcon("sayfa.png");
     b10.setText("Shuffle"); b10.setIcon(icon0); b10.setHorizontalTextPosition(JButton.CENTER);
	 b10.setVerticalTextPosition(JButton.CENTER); b10.setForeground(Color.black);  
	 b10.setFont(new Font("Serif",Font.ITALIC,20));
    
	 ImageIcon icon1 = new ImageIcon("sayfa.png");
     b11.setText("←"); b11.setIcon(icon1); b11.setHorizontalTextPosition(JButton.CENTER);
	 b11.setVerticalTextPosition(JButton.CENTER); b11.setForeground(Color.black);  
	 b11.setFont(new Font("Serif",Font.ITALIC,20));
     
	 ImageIcon icon2 = new ImageIcon("sayfa.png");
     N.setText("New Image"); N.setIcon(icon1); N.setHorizontalTextPosition(JButton.CENTER);
	 N.setVerticalTextPosition(JButton.CENTER); N.setForeground(Color.black);  
	 ...
	 if(ArtConstant%4 == 1) {
		    r1 = new ImageIcon("r1.jpeg");   r5 = new ImageIcon("r5.jpeg"); r9 = new ImageIcon("tahta.jpeg");  
		    r2 = new ImageIcon("r2.jpeg");   r6 = new ImageIcon("r6.jpeg"); 
		    r3 = new ImageIcon("r3.jpeg");   r7 = new ImageIcon("r7.jpeg");
		    r4 = new ImageIcon("r4.jpeg");   r8 = new ImageIcon("r8.jpeg");
		    
		    label = new JLabel();
		     icon = new ImageIcon("r.jpeg");
		    label.setIcon(icon);
		    label.setBounds(100,270,450,420);
		    this.add(label);
		    
	 }
	 if(ArtConstant%4 == 2) {
		    r1 = new ImageIcon("p1.jpg");   r5 = new ImageIcon("p5.jpg"); r9 = new ImageIcon("tahta.jpeg");  
		    r2 = new ImageIcon("p2.jpg");   r6 = new ImageIcon("p6.jpg"); 
		    r3 = new ImageIcon("p3.jpg");   r7 = new ImageIcon("p7.jpg");
		    r4 = new ImageIcon("p4.jpg");   r8 = new ImageIcon("p8.jpg");
		    
		    label = new JLabel();
		    icon = new ImageIcon("p.jpeg");
		    label.setIcon(icon);
		    label.setBounds(100,270,450,420);
		    this.add(label);
	 }
	 if(ArtConstant%4 == 3) {
		    r1 = new ImageIcon("k1.jpg");   r5 = new ImageIcon("k5.jpg"); r9 = new ImageIcon("tahta.jpeg");  
		    r2 = new ImageIcon("k2.jpg");   r6 = new ImageIcon("k6.jpg"); 
		    r3 = new ImageIcon("k3.jpg");   r7 = new ImageIcon("k7.jpg");
		    r4 = new ImageIcon("k4.jpg");   r8 = new ImageIcon("k8.jpg");
		    
		    label = new JLabel();
		    icon = new ImageIcon("k.jpeg");
		    label.setIcon(icon);
		    label.setBounds(100,270,450,420);
		    this.add(label);
	 }
	 if(ArtConstant%4 == 0) {
		    r1 = new ImageIcon("s1.jpg");   r5 = new ImageIcon("s5.jpg"); r9 = new ImageIcon("tahta.jpeg");  
		    r2 = new ImageIcon("s2.jpg");   r6 = new ImageIcon("s6.jpg"); 
		    r3 = new ImageIcon("s3.jpg");   r7 = new ImageIcon("s7.jpg");
		    r4 = new ImageIcon("s4.jpg");   r8 = new ImageIcon("s8.jpg");
		    
		    label = new JLabel();
		     icon = new ImageIcon("s.jpeg");
		    label.setIcon(icon);
		    label.setBounds(100,270,450,420);
		    this.add(label);
	 }
...
public void actionPerformed(ActionEvent e) {
    if(e.getSource()== b8) {
         ...
         if(e.getSource()==N) {
        	ArtConstant++;
        	 if(ArtConstant%4 == 1) {
     		    r1 = new ImageIcon("r1.jpeg");   r5 = new ImageIcon("r5.jpeg"); 
     		    r2= new ImageIcon("r2.jpeg");    r6 = new ImageIcon("r6.jpeg"); 
     		    r3 = new ImageIcon("r3.jpeg");   r7 = new ImageIcon("r7.jpeg");
     		    r4 = new ImageIcon("r4.jpeg");   r8 = new ImageIcon("r8.jpeg");
     	 ...
     	 if(ArtConstant%4 == 2) {
     		    r1 = new ImageIcon("p1.jpg");   r5 = new ImageIcon("p5.jpg");   
     		    r2 = new ImageIcon("p2.jpg");   r6 = new ImageIcon("p6.jpg"); 
     		    r3 = new ImageIcon("p3.jpg");   r7 = new ImageIcon("p7.jpg");
     		    r4 = new ImageIcon("p4.jpg");   r8 = new ImageIcon("p8.jpg");
     	 ...
     	 if(ArtConstant%4 == 3) {
     		    r1 = new ImageIcon("k1.jpg");   r5 = new ImageIcon("k5.jpg");   
     		    r2 = new ImageIcon("k2.jpg");   r6 = new ImageIcon("k6.jpg"); 
     		    r3 = new ImageIcon("k3.jpg");   r7 = new ImageIcon("k7.jpg");
     		    r4 = new ImageIcon("k4.jpg");   r8 = new ImageIcon("k8.jpg");
     	 ...
     	 if(ArtConstant%4 == 0) {
     		    r1 = new ImageIcon("s1.jpg");   r5 = new ImageIcon("s5.jpg");   
     		    r2 = new ImageIcon("s2.jpg");   r6 = new ImageIcon("s6.jpg"); 
     		    r3 = new ImageIcon("s3.jpg");   r7 = new ImageIcon("s7.jpg");
     		    r4 = new ImageIcon("s4.jpg");   r8 = new ImageIcon("s8.jpg");
